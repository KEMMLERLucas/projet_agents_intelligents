...
print(etatSuivant)
etatSuivantSuivant = pb.etatSuivant(etatSuivant,"droite")
recompense= pb.recompense(etatSuivant,"droite",etatSuivantSuivant)
print(recompense)
etatSuivantSuivantSuivant = pb.death(etatSuivantSuivant[1])
print(etatSuivantSuivantSuivant)
